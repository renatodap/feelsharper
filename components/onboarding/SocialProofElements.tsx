  ...
  const [achievements, setAchievements] = useState<Achievement[]>([
    {
      id: '1',
      user: 'You',
      action: 'can be the first to log a workout',
      timeAgo: 'Start now',
      type: 'workout',
      icon: Target,
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      name: 'Be the first',
      avatar: '🌟',
      quote: "Join our early community and help shape the future of fitness tracking.",
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      setData({
        ...
        todaySignups: 2 + Math.floor(Math.random() * 3),
        totalWorkouts: 25 + Math.floor(Math.random() * 20),
        avgRating: 5.0,
        successRate: 100,
        recentAchievements: []
      });
